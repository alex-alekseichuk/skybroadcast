...
//Operation Method @3-D17782A4
    function Operation()
    {
        ...
        $Redirect = "home_ar.php" . "?" . CCGetQueryString("QueryString", Array("ccsForm"));
...
//SetValues Method @3-FB62F0C0
    function SetValues()
    {
        $this->en->SetDBValue($this->f("ar"));
    }
//End SetValues Method

//Update Method @3-C2D2B6DE
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE strings SET "
             . "ar=" . $this->ToSQL($this->en->GetDBValue(), $this->en->DataType);
...
$FileName = "home_ar.php";
$Redirect = "";
$TemplateFileName = "home_ar.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
