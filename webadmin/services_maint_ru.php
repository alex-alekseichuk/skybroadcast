...
//SetValues Method @2-437EE2B4
    function SetValues()
    {
        $this->service_header->SetDBValue($this->f("service_header_r"));
        $this->service_desc->SetDBValue($this->f("service_desc_r"));
        $this->service_price->SetDBValue(trim($this->f("service_price")));
        $this->service_speed->SetDBValue(trim($this->f("service_speed")));
    }
//End SetValues Method

//Insert Method @2-9C753FB3
    function Insert()
    {
...
//Update Method @2-44B32E0B
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE services SET "
             . "service_header_r=" . $this->ToSQL($this->service_header->GetDBValue(), $this->service_header->DataType) . ", "
             . "service_desc_r=" . $this->ToSQL($this->service_desc->GetDBValue(), $this->service_desc->DataType) . ", "
...
$FileName = "services_maint_ru.php";
$Redirect = "";
$TemplateFileName = "services_maint_ru.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
