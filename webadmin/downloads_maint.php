...
//Update Method @2-C9AFB00E
    function Update()
    {
        ...
        $this->SQL = "UPDATE downloads SET "
             ...
             . "download_header=" . $this->ToSQL($this->download_header->GetDBValue(), $this->download_header->DataType) . ", "
             . "download_body=" . $this->ToSQL($this->download_body->GetDBValue(), $this->download_body->DataType);
...
$FileName = "downloads_maint.php";
$Redirect = "";
$TemplateFileName = "downloads_maint.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
