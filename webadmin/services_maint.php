...
//Update Method @2-C6A7BCD3
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE services SET "
             . "service_header=" . $this->ToSQL($this->service_header->GetDBValue(), $this->service_header->DataType) . ", "
             . "service_desc=" . $this->ToSQL($this->service_desc->GetDBValue(), $this->service_desc->DataType) . ", "
...
$FileName = "services_maint.php";
$Redirect = "";
$TemplateFileName = "services_maint.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
