...
//SetValues Method @2-B0FA1B37
    function SetValues()
    {
        $this->news_date->SetDBValue($this->f("news_date"));
        $this->news_header->SetDBValue($this->f("news_header_a"));
        $this->news_body->SetDBValue($this->f("news_body_a"));
    }
//End SetValues Method

//Insert Method @2-1D33F91C
    function Insert()
    {
...
//Update Method @2-3E38FC7D
    function Update()
    {
        ...
        $this->SQL = "UPDATE news SET "
             ...
             . "news_header_a=" . $this->ToSQL($this->news_header->GetDBValue(), $this->news_header->DataType) . ", "
             . "news_body_a=" . $this->ToSQL($this->news_body->GetDBValue(), $this->news_body->DataType);
...
$FileName = "news_maint_ar.php";
$Redirect = "";
$TemplateFileName = "news_maint_ar.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
