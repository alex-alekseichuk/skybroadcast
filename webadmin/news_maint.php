...
//SetValues Method @2-23DC64A9
    function SetValues()
    {
        $this->news_date->SetDBValue($this->f("news_date"));
        $this->news_header->SetDBValue($this->f("news_header"));
        $this->news_body->SetDBValue($this->f("news_body"));
    }
//End SetValues Method

//Insert Method @2-8338BC19
    function Insert()
    {
...
//Update Method @2-FF758BBD
    function Update()
    {
        ...
        $this->SQL = "UPDATE news SET "
             ...
             . "news_header=" . $this->ToSQL($this->news_header->GetDBValue(), $this->news_header->DataType) . ", "
             . "news_body=" . $this->ToSQL($this->news_body->GetDBValue(), $this->news_body->DataType);
