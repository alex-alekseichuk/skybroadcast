...
//SetValues Method @2-4A24C57D
    function SetValues()
    {
        $this->product_header->SetDBValue($this->f("product_header_r"));
        $this->product_desc->SetDBValue($this->f("product_desc_r"));
    }
//End SetValues Method

//Insert Method @2-4354B1AC
    function Insert()
    {
...
//Update Method @2-76C26B87
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE products SET "
             . "product_header_r=" . $this->ToSQL($this->product_header->GetDBValue(), $this->product_header->DataType) . ", "
             . "product_desc_r=" . $this->ToSQL($this->product_desc->GetDBValue(), $this->product_desc->DataType);
...
$FileName = "products_maint_ru.php";
$Redirect = "";
$TemplateFileName = "products_maint_ru.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
