...
//SetValues Method @2-26E1709D
    function SetValues()
    {
        $this->download_url->SetDBValue($this->f("download_url"));
        $this->download_header->SetDBValue($this->f("download_header_r"));
        $this->download_body->SetDBValue($this->f("download_body_r"));
    }
//End SetValues Method

//Insert Method @2-22F62CDA
    function Insert()
    {
...
//Update Method @2-184972E5
    function Update()
    {
        ...
        $this->SQL = "UPDATE downloads SET "
             ...
             . "download_header_r=" . $this->ToSQL($this->download_header->GetDBValue(), $this->download_header->DataType) . ", "
             . "download_body_r=" . $this->ToSQL($this->download_body->GetDBValue(), $this->download_body->DataType);
...
$FileName = "downloads_maint_ru.php";
$Redirect = "";
$TemplateFileName = "downloads_maint_ru.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
