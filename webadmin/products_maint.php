...
//Update Method @2-6793E29A
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE products SET "
             . "product_header=" . $this->ToSQL($this->product_header->GetDBValue(), $this->product_header->DataType) . ", "
             . "product_desc=" . $this->ToSQL($this->product_desc->GetDBValue(), $this->product_desc->DataType);
