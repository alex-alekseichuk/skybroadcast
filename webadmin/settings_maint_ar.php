...
//SetValues Method @2-1E962DA8
    function SetValues()
    {
        $this->setting_header->SetDBValue($this->f("setting_header_a"));
        $this->setting_desc->SetDBValue($this->f("setting_desc_a"));
    }
//End SetValues Method

//Insert Method @2-7B04F3D6
    function Insert()
    {
...
//Update Method @2-75154490
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE settings SET "
             . "setting_header_a=" . $this->ToSQL($this->setting_header->GetDBValue(), $this->setting_header->DataType) . ", "
             . "setting_desc_a=" . $this->ToSQL($this->setting_desc->GetDBValue(), $this->setting_desc->DataType);
...
$FileName = "settings_maint_ar.php";
$Redirect = "";
$TemplateFileName = "settings_maint_ar.html";
$BlockToParse = "main";
$TemplateEncoding = "";
$FileEncoding = "";
$PathToRoot = "./";
