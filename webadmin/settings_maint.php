...
//Update Method @2-B3C4D559
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE settings SET "
             . "setting_header=" . $this->ToSQL($this->setting_header->GetDBValue(), $this->setting_header->DataType) . ", "
             . "setting_desc=" . $this->ToSQL($this->setting_desc->GetDBValue(), $this->setting_desc->DataType);
