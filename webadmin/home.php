...
//Operation Method @3-04D8B96B
    function Operation()
    {
        ...
        $Redirect = "home.php" . "?" . CCGetQueryString("QueryString", Array("ccsForm"));
...
//SetValues Method @3-7B391633
    function SetValues()
    {
        $this->en->SetDBValue($this->f("en"));
    }
//End SetValues Method

//Update Method @3-9C169CA6
    function Update()
    {
        $this->CmdExecution = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $this->SQL = "UPDATE strings SET "
             . "en=" . $this->ToSQL($this->en->GetDBValue(), $this->en->DataType);
