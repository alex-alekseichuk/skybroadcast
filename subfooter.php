<?php
class clssubfooter { //subfooter class @1-2CB1CA5D
...
//Class_Initialize Event @1-AA794186
    function clssubfooter($RelativePath)
    {
        $this->RelativePath = $RelativePath;
        $this->Visible = true;
        $this->FileName = "subfooter.php";
        $this->Redirect = "";
        $this->TemplateFileName = "subfooter.html";
...
} //End subfooter Class @1-FCB6E20C
